package mx.gob.comude.persistencia;
...
import mx.gob.comude.model.StatusReporte;

/**
 * Autor: Uriel Infante
 * Archivo de mx.gob.comude.persistencia para la tabla bitácora de la base de datos.
