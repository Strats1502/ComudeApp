...
import mx.gob.comude.adapters.RVTweetAdapter;
import mx.gob.comude.api.TwitterAPI;
...
public class TwitterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Call<ArrayList<Tweet>> call = twitterAPI.get(sharedPreferences.getString(MyApplication.URL_TWITTER, "ComudeLeon"), authorizationHeader());
    ...
    private String authorizationHeader() {
        ...
        return "OAuth oauth_consumer_key=\"zHb326FK2xT666c0olifieF9h\",oauth_token=\"865314952470560768-BZ5AXIzHyRndtxWqcYe8u2rKMIb25cF\",oauth_signature_method=\"HMAC-SHA1\",oauth_timestamp=\"1498079803\",oauth_nonce=\"JJFTGR\",oauth_version=\"1.0\",oauth_signature=\"Ji7O9BfHY3NTCOSrWPDKTQ7I6Fk%3D\"";
        //return header;
    }
